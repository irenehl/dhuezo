...
Food Dice resuelve la indecisión al elegir dónde comer usando Google Maps Places API y un algoritmo aleatorio, permitiendo descubrir restaurantes acorde a preferencias y ubicación de forma rápida y divertida. Maneja permisos de ubicación y errores de manera amigable, ofrece experiencia fluida en iOS/Android, y da mensajes claros en inglés y español. Su arquitectura es escalable y asegura que la app funcione bien incluso ante errores o falta de resultados.
